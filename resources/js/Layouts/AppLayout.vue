...
import { Book, Building, LibraryBig, LayoutDashboard, User2Icon, UserPen, ShoppingCart, Activity } from "@lucide/vue";
...
watch(() => page.props.flash, (flash) => {
    if (shownMessages.value.size >= MAX_MESSAGES) {
                           ...
                           <ul class="sidebar-nav-list">
                                ...
                                <li>
                                    <NavLink :href="route('admin.logs.index')" :active="route().current('admin.logs.index')">
                                        <Activity :size="20" />
                                        <span v-if="sidebarOpen">Atividade</span>
                                    </NavLink>
                                </li>
                           </ul>
                        </div>
