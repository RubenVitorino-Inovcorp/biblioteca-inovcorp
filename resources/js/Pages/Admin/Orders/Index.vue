    ...
    <template #header>
        ...
        <div class="flex justify-between space-x-2 items-center">
            ...
            <div class="header-actions">
                <FilterDropdown
                    route-name="admin.encomendas.index"
                    :filters="filters"
      ...
      <TableWrapper>
          ...
          <template #body>
              <tr v-for="order in orders.data" :key="order.id" class="hover:bg-base-300">
                  <td>
                      <Link class="hover:text-primary" :href="route('admin.encomendas.show', order.id)">
                          {{ order.order_number }}
                      </Link>
                  </td>
                  ...
                  <td>
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                            <Link class="hover:text-primary" :href="route('utilizadores.show', order.user.id)">
                                {{ order.user.name }}
                            </Link>
                        </div>
                      </div>
