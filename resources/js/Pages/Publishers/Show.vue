  ...
  <Layout>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
          ...
          <div class="col-span-2 space-y-4">
              <Link :href="route('editoras.edit', publisher.id)"><h1 class="text-3xl font-bold text-base-content flex">{{ publisher.name }}<Pencil/></h1></Link>
          </div>
      </div>
      ...
      <div v-if="books.length > 0">
          ...
          <h1 class="text-3xl font-bold text-base-content">Livros de {{ publisher.name }}</h1>
