...
<template>
    ...
    <form @submit.prevent="submit" :class="isModal ? 'w-full' : 'max-w-xl mx-auto p-8 bg-base-100 rounded-2xl shadow-sm border border-gray-100'">
        <div v-if="!isModal" class="mb-6 pb-4 border-b border-gray-100">
            <h2 class="text-xl font-bold font-['Manrope'] text-base-content">Atualizar Dados da Editora</h2>
        </div>
        ...
        <div class="form-control mt-4">
            <label class="label font-semibold text-base-content/70">Lógotipo da editora</label>
            <input
                type="file"
