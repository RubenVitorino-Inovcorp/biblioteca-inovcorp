...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são as mensagens predefinidas que
    | correspondem aos motivos fornecidos pelo gestor de palavras-passe
    | para uma tentativa de atualização de palavra-passe que falhou.
    |
    */
