...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem contêm as mensagens de erro predefinidas
    | utilizadas pela classe validator. Algumas destas regras têm várias versões,
    | tais como as regras de tamanho. Sinta-se à vontade para ajustar cada
    | uma destas mensagens aqui.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O :attribute indicado apareceu numa fuga de dados. Por favor, escolha um :attribute diferente.',
    ],
    ...
    'required_without_all' => 'O campo :attribute é obrigatório quando nenhum dos seguintes valores estão presentes: :values.',
    ...
    | utilizando a convenção "attribute.rule" para nomear as linhas. Isso
    | torna rápido especificar uma linha de linguagem personalizada específica.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são utilizadas para trocar o nosso
    | placeholder de atributo por algo mais legível, como "Endereço de E-mail"
    | em vez de "email". Isso ajuda-nos a tornar a mensagem mais expressiva.
    |
    */
